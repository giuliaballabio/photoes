...
v = np.array(map(float, [lines.split()[0] for lines in open('../data_b'+str(b)+'_r'+str(r_in)+'/line_profile_i'+str(round(incl_deg, 2))+'.txt', 'r')]))
line_flux = np.array(map(float, [lines.split()[1] for lines in open('../data_b'+str(b)+'_r'+str(r_in)+'/line_profile_i'+str(round(incl_deg, 2))+'.txt', 'r')]))
...
if incl_deg == 0.0:
    ...
    plt.savefig('../data_b'+str(b)+'_r'+str(r_in)+'/line_profile_i'+str(round(incl_deg, 2))+'.png', format='png', bbox_inches='tight')
    plt.show()
else:
    plt.figure()
    plt.plot(v, line_flux / np.amax(line_flux), 'r')
...
#plt.savefig('../data_b'+str(b)+'_r'+str(r_in)+'/boundary_condition.png', format='png', bbox_inches='tight')
#plt.show()
#
#plt.figure()
...
#plt.axis([0., 30., 0., 6.])
#plt.savefig('../data_b'+str(b)+'_r'+str(r_in)+'/vth_atbound_'+str(round(incl_deg, 2))+'.png', format='png', bbox_inches='tight')
#plt.show()
#
#plt.figure()
...
#plt.savefig('../data_b'+str(b)+'_r'+str(r_in)+'/rho_vth_'+str(round(incl_deg, 2))+'.png', format='png', bbox_inches='tight')
#plt.show()
...
#plt.savefig('../data_b'+str(b)+'_r'+str(r_in)+'/rho_vth_zoom_'+str(round(incl_deg, 2))+'.png', format='png', bbox_inches='tight')
#plt.show()
