...
plt.tight_layout()
plt.legend(bbox_to_anchor=(0., 1.), loc='upper left', ncol=2)
plt.savefig('./observables/'+str(species)+'/vpeak_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_10kms.png', format='png', dpi=300, bbox_inches='tight')
plt.savefig('./observables/'+str(species)+'/eps/vpeak_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_10kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.legend(bbox_to_anchor=(0., 1.), loc='upper left', ncol=2)
plt.savefig('./observables/'+str(species)+'/vpeak_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_5kms.png', format='png', dpi=300, bbox_inches='tight')
plt.savefig('./observables/'+str(species)+'/eps/vpeak_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_5kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.legend(bbox_to_anchor=(0., 1.), loc='upper left', ncol=2)
plt.savefig('./observables/'+str(species)+'/vpeak_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_3kms.png', format='png', dpi=300, bbox_inches='tight')
plt.savefig('./observables/'+str(species)+'/eps/vpeak_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_3kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
ax[0,0].ylabel(r'$- v_{peak} \, [km/s]$')
ax[0,0].axis([-1., 91., -0.5, 17.5])
...
ax[0,1].title('$[NeII] \, 12.81 \mu m$')
ax[0,1].axis([-1., 91., -0.5, 17.5])
...
ax[1,0].xlabel(r'$i \, [^{\circ}]$')
ax[1,0].ylabel(r'$FWHM \, [km/s]$')
ax[1,0].axis([-1., 91., 5., 60.])
...
ax[1,2].axis([-1., 91., 5., 60.])
for row in range(2):
    for col in range(3):
        ax[row,col].errorbar(incl_data2, np.abs(fwhm_data2), yerr=err_fwhm_data2, color='k', linestyle='None', marker='*', capsize=3, label='$Pascucci\,&\,Sterzik\,(2009)$')
        for i in range(len(name)):
            ax[row,col].annotate(name[i], (incl_data2[i]+0.3, np.abs(fwhm_data2[i])+0.3))
        ax[row,col].errorbar(incl_data3, np.abs(fwhm_data3), yerr=err_fwhm_data3, color='k', linestyle='None', marker='d', capsize=3, label='$Baldovin-Saavedra\,(2012)$')
        for i in range(len(name3)):
            ax[row,col].annotate(name3[i], (incl_data3[i]-12.0, np.abs(fwhm_data3[i])-0.1))
        plt.errorbar(incl_data, np.abs(fwhm_data), yerr=err_fwhm_data, color='k', linestyle='None', marker='o', capsize=3, label='$Sacco\,et\,al.\,(2012)$')
        for i in range(len(ID)):
...
plt.savefig('./observables/'+str(species)+'/eps/fwhm_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_subplt.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.legend(bbox_to_anchor=(0., 1.), loc='upper left', ncol=2)
plt.savefig('./observables/'+str(species)+'/fwhm_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_5kms.png', format='png', dpi=300, bbox_inches='tight')
plt.savefig('./observables/'+str(species)+'/eps/fwhm_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_5kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.legend(bbox_to_anchor=(0., 1.), loc='upper left', ncol=2)
plt.savefig('./observables/'+str(species)+'/fwhm_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_3kms.png', format='png', dpi=300, bbox_inches='tight')
plt.savefig('./observables/'+str(species)+'/eps/fwhm_soundspeed_b'+str(b)+'_R'+str(R)+'_'+str(mdot)+'_data_3kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('./observables/'+str(species)+'/eps/vpeak_soundspeed_b'+str(b)+'_R'+str(R[1])+'_'+str(mdot)+'_data_10kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('./observables/'+str(species)+'/eps/vpeak_soundspeed_b'+str(b)+'_R'+str(R[1])+'_'+str(mdot)+'_data_5kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('./observables/'+str(species)+'/eps/vpeak_soundspeed_b'+str(b)+'_R'+str(R[1])+'_'+str(mdot)+'_data_3kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('./observables/'+str(species)+'/eps/fwhm_soundspeed_b'+str(b)+'_R'+str(R[1])+'_'+str(mdot)+'_data_10kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('./observables/'+str(species)+'/eps/fwhm_soundspeed_b'+str(b)+'_R'+str(R[1])+'_'+str(mdot)+'_data_5kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('./observables/'+str(species)+'/eps/fwhm_soundspeed_b'+str(b)+'_R'+str(R[1])+'_'+str(mdot)+'_data_3kms.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()
