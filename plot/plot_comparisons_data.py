...
plt.tight_layout()
plt.legend(bbox_to_anchor=(0., 1.1), loc='upper left')
plt.savefig('./observables/'+str(species)+'/vcentroverfwhm_soundspeed_b'+str(b)+'_R'+str(R[0])+'_'+str(mdot)+'_data.png', format='png', dpi=300, bbox_inches='tight')
plt.savefig('./observables/'+str(species)+'/eps/vcentroverfwhm_soundspeed_b'+str(b)+'_R'+str(R[0])+'_'+str(mdot)+'_data.eps', format='eps', dpi=300, bbox_inches='tight')
plt.show()
