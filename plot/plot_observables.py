...
#
# plt.figure()
# plt.plot(incl_deg, fwhm1, color='#41b6c4', linestyle='-', linewidth=2.5, marker='None', markeredgecolor='#41b6c4', label='$R = '+str(R[0])+'$')
...
plt.plot(incl_deg, fwhm4*1.009, color='#4d004b', linestyle='-', linewidth=2.5, marker='None', markeredgecolor='#4d004b', label='$[SII]\,6718\,\AA$')
# plt.plot(incl_hydro, fwhm_hydro, color='k', linestyle='dotted', label='$Alexander \, (2008)$')
plt.xlabel(r'$i \, [^{\circ}]$')
plt.ylabel(r'$FWHM \, [km/s]$')
plt.xticks(np.arange(min(incl_deg), max(incl_deg)+10., 10.0))
...
# plt.plot(incl_deg, rlaunch4, color='#4d004b', linestyle='-', linewidth=2.5, marker='None', markeredgecolor='#4d004b', label='$[SII]\,6718\,\AA$')
# plt.xlabel(r'$i \, [^{\circ}]$')
# plt.ylabel(r'$R_0 \, [au]$')
# plt.xticks(np.arange(min(incl_deg), max(incl_deg)+10., 10.0))
# # plt.title('b = '+str(b)+' - R$_{in}$ = '+str(r_in)+' Rg - R$_{out}$ = '+str(r_out)+' Rg')
