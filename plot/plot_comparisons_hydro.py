...
plt.savefig('./observables/vpeak_hydro_species.png', format='png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.legend(loc='best')
plt.savefig('./observables/fwhm_hydro_species.png', format='png', dpi=300, bbox_inches='tight')
plt.show()
